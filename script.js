function initPage() {
    ...
    // API key
    var APIKey = "959007a538cf1b24bf533deb6939156a";
    ...
    function getWeather(cityName) {
        ...
        axios.get(queryURL)
            .then(function (response) {
                ...
                todayweatherEl.classList.remove("5days");
                ...
                currentTempEl.innerHTML = "Temperature: " + temperature(response.data.main.temp) + " &#176C";
                ...
                axios.get(forecastQueryURL)
                    .then(function (response) {
                        fivedayEl.classList.remove("5days");
                        ...
                        for (i = 0; i < forecastEls.length; i++) {
                            ...
                            forecastTempEl.innerHTML = "Temp: " + temperature(response.data.list[forecastIndex].main.temp) + " &#176C";
    ...
    function renderSearchHistory() {
        ...
        for (var i = 0; i < searchHistory.length; i++) {
            ...
            historyItem.setAttribute("class", "form-control historybtn d-block");
